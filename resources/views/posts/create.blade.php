    ...
    <section class="text-gray-600 body-font relative">
      <div class="container px-5 py-5 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-indigo-900 text-bold">アウトプット</h1>
        ...
        <form method="post" action="{{ route('posts.store') }}" enctype="multipart/form-data">
          ...
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
              <div class="relative">
                ...
                <div class="px-4">
                  ...
                  <label for="category_M" class="leading-5 text-sm text-gray-600 px-2">カテゴリ大</label></br>
                  <input type="text" id="category_L" name="category_L" value="{{ old('title') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                  <label for="category_S" class="leading-5 text-sm text-gray-600 px-2">カテゴリ小</label></br>
                  <input type="text" id="category_S" name="category_S" value="{{ old('title') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                </div>
              </div>
            </div>
            <div class="p-2 w-full">
            ...
            <div class="p-2 w-full">
              <div class="relative">
                <label for="files" class="leading-7 text-sm text-gray-600 border-l-4 border-indigo-900 px-1">ファイル添付</label>
                <div class="flex items-center justify-center w-full">
                    <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                            ...
                            <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, GIF, MP3, MP4 or PDF (MAX. 800x400px)</p>
                        </div>
