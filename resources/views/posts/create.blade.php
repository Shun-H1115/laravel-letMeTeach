          ...
          <div class="flex flex-wrap -m-2">
            ...
            <div class="p-2 w-full">
              <div class="relative">
                ...
                <select id="category" name="category" class="w-1/2 rounded border">
            ...
            <div class="p-2 w-full">
              <div class="relative">
                <label for="file_data" class="leading-7 text-sm text-gray-600">ファイル添付</label>
                ...
                <input type="file" id="dropzone-file" name="file_data" class="hidden" />
            </div>
            <div class="p-2 w-full flex justify-around mt-4">
              <button onclick="location.href='{{ route('categories.index') }}'" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
              <button class="text-white bg-indigo-900 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">投稿</button>
            </div>
